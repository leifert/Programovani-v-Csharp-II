...
namespace cyklopujcovna
{
    ...
    public partial class BikeInsertForm : Form
    {
        private Bike bike;
        private MainForm main;
        public BikeInsertForm(Bike bike, MainForm main)
        {
            InitializeComponent();
            this.bike = bike;
            this.main = main;
        ...
        private async void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult dialogResult = MessageBox.Show( "Opravdu chce přidat nové kolo?","Cyklopůjčovna", MessageBoxButtons.YesNo);
                if(dialogResult == DialogResult.Yes)
                {
                    ...
                    DialogResult dialog = MessageBox.Show("Kolo bylo přidáno!");
